...
from utilities.utils import maximal_marginal_relevance
from vectorstores.inmemorydb.constants import (
...
if TYPE_CHECKING:
    ...
    from vectorstores.inmemorydb.filters import InMemoryDBFilterExpression
    from vectorstores.inmemorydb.schema import InMemoryDBModel
...
class InMemoryVectorStore(VectorStore):
    ...
    def from_texts_return_keys(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            from vectorstores.inmemorydb.schema import read_schema
    ...
    def _get_schema_with_defaults(
        ...
        from vectorstores.inmemorydb.schema import (
            InMemoryDBModel,
            read_schema,
        )
